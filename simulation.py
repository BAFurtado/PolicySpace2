...
class Simulation:
    ...
    def monthly(self):
        ...
        for firm in self.firms.values():
            firm.update_product_quantity(self.PARAMS['PRODUCTIVITY_EXPONENT'], self.PARAMS['PRODUCTIVITY_MAGNITUDE_DIVISOR'])
        ...
        for firm in self.construction_firms.values():
            ...
            firm.plan_house(self.regions.values(), self.houses.values(), self.PARAMS, self.seed)
